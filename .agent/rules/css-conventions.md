# CSS/SCSS Coding Rules - Antigravity
...
## Root Element Naming
- Views/Pages: `.view_name_view` or `.page_name_page`
...
- ❌ PROHIBITED: Repeated patterns (extract as classes/shared styles)

## Key Rules
1. Each element uses ONLY ONE className.
2. Each element MUST have a UNIQUE className - Critical for quick DOM debugging in DevTools and specific rule scoping.
